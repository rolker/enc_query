...
def enc_query_client(path, directory, layers, longitude, latitude, azimuth, distance, view_angle):
    ...
    try:
        ...
        resp1 = enc_query(path, directory, layers, longitude, latitude, azimuth, distance, view_angle)
        print("Got Response")
        return resp1
